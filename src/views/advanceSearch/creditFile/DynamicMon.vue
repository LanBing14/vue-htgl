<template>
  <el-row class="credit-tab-content"  v-loading="loading">
    ...
    <el-col style="margin:15px 0;">
      ...
      <div class="fxb-tab-p marT-2 marB10">
      ...
      <div v-if="riskSmallItems.length" class="fxb-tab-p marT-2 marB10">
            ...
            if (
              ...
              if (row.type_code === "A020401") {
                ...
                return (
                  ...
                  const diffArr = Diff.diffChars(str11, str2);
                  ...
                  return (<div style="white-space: nowrap;overflow: hidden;text-overflow: ellipsis;"  domPropsInnerHTML={allStr}></div>)
              }
            }
          },
        },
...
.fxb-tab-p.second .el-form-item__content {
...
.fxb-tab-p span:hover,
.fxb-tab-p span.active {
  color: #409eff;
}
