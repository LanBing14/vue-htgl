<template>
    <el-row class="credit-tab-content">
        <Comp1 ref="comp1" @updateBaseInfo="updateBaseInfo" :isFxb="isFxb"></Comp1>
        <Comp2 :baseInfo="baseInfo"  :isFxb="isFxb"></Comp2>
        <Comp3 :baseInfo="baseInfo"  :isFxb="isFxb"></Comp3>
        <Comp4 :baseInfo="baseInfo"  :isFxb="isFxb"></Comp4>
        <Comp5 :baseInfo="baseInfo"  :isFxb="isFxb"></Comp5>
    </el-row>
</template>
