    ...
    <el-row class="credit-tab-content">
        ...
        >
            ...
            <el-table-column label="公开日期" width="110">
                <template slot-scope="scope">{{ scope.row.publicationDate | dateFormat('yyyy-MM-dd') }}</template>
            </el-table-column>
        </el-table>
        <el-pagination
            class="fxb-page"
        ...
        >
            ...
            <el-table-column label="登记日期" width="110">
                <template
                    slot-scope="scope"
                >{{ scope.row.registerAperDate | dateFormat('yyyy-MM-dd') }}</template>
            </el-table-column>
...
export default {
    ...
    data() {
        return {
            errorImg:
                'this.src="' +
                require("../../../assets/images/zanwutupian.png") +
                '"',
            companyId: null,
            companyName: null,
            // 专利信息，包括列表和分页信息
            ...
            Api_getBasicInfo(7, {
                ...
                .then(res => {
                    if (res) {
                        ...
                        this.softwareCopyrightsData.totalRecords =
                            res.totalRecords;
                    } else {
            ...
            Api_getBasicInfo(22, {
                ...
                .then(res => {
                    if (res) {
                        ...
                        this.certificationData.totalRecords =
                            res.totalRecords;
                    } else {
