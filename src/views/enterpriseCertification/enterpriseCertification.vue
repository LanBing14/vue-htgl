<template>
  <el-container style="background:#f7f8fa">
    ...
    <el-main style="background:#fff;margin: 20px auto;">
      <div class="bottomLine">
         <span class="renzhengTitle">
            企业认证
         </span>
         <span class="cuLine"></span>
      </div>
        <el-form
        ...
        <div style="text-align: left;margin-top: 30px;margin-left: 121px;" v-if="!switchDisabled">
