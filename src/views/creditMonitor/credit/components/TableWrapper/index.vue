<template>
  <div class="tableWrapper">
    ...
    >
      <template slot="empty">
        <img src="../../../../../assets/images/bg/no.jpg" alt="" style="width: 300px;height:236px">
      </template>
      ...
      >
        <template slot-scope="scope"> 
          ...
          <span v-if="scope.$index=='0'" class="one qiansan">
           {{getTableIndex(scope.$index)}} 
          </span>
          <span v-else-if="scope.$index=='1'" class="two qiansan">
           {{getTableIndex(scope.$index)}} 
          </span>
          <span v-else-if="scope.$index=='2'" class="three qiansan">
            {{getTableIndex(scope.$index)}} 
          </span>
          <span v-else>
            {{getTableIndex(scope.$index)}} 
