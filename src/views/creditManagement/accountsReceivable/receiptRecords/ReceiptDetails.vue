            ...
            <el-row>
              <el-col :span="16">
                <el-form-item label="收款附件">
                  ...
                  <ImgView :urls="details.register.uploadFiles"></ImgView>
                </el-form-item>
              </el-col>
            </el-row>
            <el-divider class="detail-divider"></el-divider>
                  ...
                  <el-form-item label="核销附件">
                    ...
                    <!-- <template v-if="details.cancellations[0].files&&details.cancellations[0].files.length">
                      <el-image
                        ...
                        style="width: 100px; height: 100px; margin-right: 6px; margin-top: 6px"
                        :src="imageUrl + iimg.url"
                        :preview-src-list="dealFImage"
                      ></el-image>
                    </template>
                    <span v-else>-</span> -->

                      <ImgView :urls="details.cancellations[0].files"></ImgView>
                  </el-form-item>
                </el-col>
              </el-row>
              <el-divider class="detail-divider"></el-divider>
...
export default {
  ...
  methods: {
    open(_rID) {
      ...
      Api_collectionRcordDetails(_rID)
        .then(res => {
          loading.close();
          this.details = res;
        })
