<template>
    <Dialog ref="drawer" class="size-btn-change" title="签约登记" :visible.sync="visible" :onOk="handleSure" width="500px" @close="closeDialog">
        <el-form ref="form" :model="form" label-width="110px">
            ...
            <el-form-item label="订单编码/名称">
                <span
                    class="canClick"
                    @click="goContractNameDetail(rowData.id)"
                >{{ rowData.contractCode+'/'+rowData.contractName }}</span>
            </el-form-item>
...
import { Api_orderSign } from "@/api/creditManagement/contractManagement/orders.js";
...
export default {
    ...
    methods: {
        ...
        handleSure() {
            ...
            Api_orderSign(this.rowData.id, this.form)
                .then(res => {
                    loading.close();
