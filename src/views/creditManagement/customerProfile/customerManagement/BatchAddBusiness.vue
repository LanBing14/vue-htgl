  ...
  >
    <div v-loading="loading">
        ...
        <el-col :span="10">
          <div style="text-align: right">
            <a
              ...
              :href="baseUrl+fxb+'/ecm/customer/archives/download'"
            >模板下载</a>
            <el-upload
              v-show="false"
              :headers="uploadHeaders"
              :action="baseUrl+fxb+'/ecm/customer/archives/excel-batchCustomer'"
              name="excelFile"
      ...
      <el-table :data="tableDataFiltered" style="width: 100%; margin-top: 8px">
        ...
        <el-table-column label="法定代表人" width="90">
          <template slot-scope="scope">
...
import { Api_batchAddCustomers } from "@/api/creditManagement/customerProfile/customerManagement.js";
import { Api_CheckCompany } from "@/api/creditManagement/customerProfile/customerManagement.js";
export default {
  name: "BatchAddBusiness",
  data() {
    return {
      fxb,
