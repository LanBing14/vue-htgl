<template>
  <el-row class="credit-tab-content">
    ...
    <h4 class="flex">
      ...
      <el-button size="mini" @click="addRisk" >新增风险</el-button>
    </h4>
    <el-row class="area">
    ...
    <FollowUpInves ref="ref_FollowUpInves" @getList="getTrackingSurveyTable"></FollowUpInves>

    <!-- 经营环境 -->
    <h4 class="flex">
      <span class="flex-primary">经营环境</span>
      <el-button size="mini" @click="jingYClick" >{{ formData1.id ? '编辑' : '新增' }}</el-button>
    </h4>
    <el-row class="area">
...
export default {
  ...
  methods: {
    ...
    addRisk(){
      ...
      this.$refs.ref_FollowUpInves.open(this.id)
    },
