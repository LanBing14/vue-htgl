  ...
  <el-row class="credit-tab-content">
    ...
    <el-row v-loading="comLoading">
      <table border="0" cellpadding="0" cellspacing="0" class="fxb-info-table">
        ...
        <tr>
          <th>企业类型</th>
          <td>{{ companyInfo.econKind !== null ? companyInfo.econKind : '-' }}</td>
          <th>是否为纳税信用A级</th>
          <td>下载报告可见</td>
        </tr>
        <tr>
    ...
    <el-row v-loading="companyPartnersLoading">
      <el-table :data="companyPartnersData.result" border class="fxb-el-table" style="width: 100%">
        ...
        <el-table-column prop="address" label="实缴额（万元）"></el-table-column>
        <el-table-column prop="address" label="实缴出资日期"></el-table-column>
        <el-table-column label="比例" prop="stockPercent" width="70"></el-table-column>
        <el-table-column label="出资形式" prop="investName"></el-table-column>
        <el-table-column label="证照号（企业代码/身份证）" prop="identifyNo" width="220"></el-table-column>
      </el-table>
      <el-pagination
        class="fxb-page"
    ...
    <el-row v-loading="investInfoLoading">
      <el-table :data="investInfoData.result" border class="fxb-el-table" style="width: 100%">
        ...
        <el-table-column label="被投资企业名称" prop="name"></el-table-column>
        <el-table-column label="注册资本（万元）" prop="registCapi"></el-table-column>
        <el-table-column label="出资比例" prop="address" width="120">
          <template slot-scope="scope">
            <span>下载报告可见</span>
          </template>
        </el-table-column>
        <el-table-column label="统一社会信用代码（注册号）" prop="no"></el-table-column>
      </el-table>
      <el-pagination
        class="fxb-page"
    ...
    <el-row v-loading="branchLoading">
      <el-table :data="branchData.result" border class="fxb-el-table" style="width: 100%">
        ...
        <el-table-column label="统一社会信用代码（注册号）" prop="regNo"></el-table-column>
        <el-table-column label="注册机关" prop="belongOrg"></el-table-column>
      </el-table>
      <el-pagination
        class="fxb-page"
              ...
              case 4: // 工商变更记录
                ...
                for (const result of this.changeData.result) {
                  if (result["beforeContent"]) {
                    result["beforeContent"] = result["beforeContent"]
                      .replace(
                        new RegExp("【新增】", "gm"),
                  ...
                  if (result["afterContent"]) {
                    result["afterContent"] = result["afterContent"]
                      .replace(
                        new RegExp("【新增】", "gm"),
                        "<span style='color:red'>【新增】</span>"
                      )
