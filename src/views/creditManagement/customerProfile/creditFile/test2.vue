  ...
  <el-row class="credit-tab-content">
    ...
    <el-row v-loading="loseCreditExecuteLoading">
      <el-table :data="loseCreditExecuteData.result" border class="fxb-el-table" style="width: 100%">
        ...
        <el-table-column label="执行法院" prop="executeUnit"></el-table-column>
    ...
    <el-row v-loading="chinacourtLoading">
      <el-table :data="chinacourtData.result" border class="fxb-el-table" style="width: 100%">
        ...
        <el-table-column label="公告内容/许可证号" prop="content"></el-table-column>
      </el-table>
      <el-pagination
        class="fxb-page"
...
export default {
  ...
  methods: {
    loadTableData(type, option) {
      Api_getBasicInfo(type, Object.assign(this.searchData, { pageNo: 1, pageSize: 10 }, option))
        .then(res => {
          if (res) {
            switch (type) {
              case 12: // 被执行人信息
