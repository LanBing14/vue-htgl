<template>
    <div class="apply-wrapper-other">
        <div class="content-other">
        <img src="../../../../assets/images/xxzj.jpg" alt="" class="img-top1">
        <div class="line-title">{{companyName}}</div>
        <div class="apply-write-content ">
            ...
            <div class="downLoad clearfix">
                ...
                <div class="fl" >
                  <p class="detail-attach" v-for="item in declarationList.uploadFiles" :key="item.id" @click="checkFiles(item)">{{item.fileName}}</p>
                </div>
              </div>
        ...
        <div class="apply-write-next ">
            <el-form :model="resultData"  ref="ruleForm" label-width="100px" class="demo-ruleForm">
                    ...
                    <div :key="item.questionId"  v-for="(item,index) in resultData.questions">
                            ...
                            :prop="'questions.' + index + '.fillblankanswer'">
                                ...
                                <div class="right-content-next clearfix">
                                    ...
                                    <div class="search-next">
                                        <el-input type="textarea" autosize v-model="item.fillblankanswer"   placeholder="请输入内容" :disabled="!submitBtn">
                                        </el-input>
                                    </div>
                                </div>
                        </el-form-item>
                        ...
                        >
                            ...
                            <div class="right-content-next">
                                ...
                                <div class="right-next-remind">{{item.auxiliaryExplain}}</div>
                                <div class="search-next">
                                    <el-radio-group v-model="item.singlechoiceanswer" :disabled="!submitBtn">
                        ...
                        <el-form-item
                         v-if="item.questionType == 'multiple_choice'"
                            :rules="{required: true, message: '不能为空', trigger: 'change'}"
                        ...
                        >
                            ...
                            <div class="right-content-next">
                                ...
                                <div class="right-next-remind">{{item.auxiliaryExplain}}</div>
                                <div class="search-next">
                                    <el-checkbox-group v-model="item.multiplechoiceanswer" :disabled="!submitBtn">
                                        <el-checkbox
                        ...
                        <el-form-item v-if="item.questionType == 'pull_down'"
                            ...
                            <div class="right-content-next">
                                ...
                                <div class="right-next-remind">{{item.auxiliaryExplain}}</div>
                                <div class="search-next">
                                    <el-select  style="width:100%" v-model="item.pulldownanswer" placeholder="请选择" :disabled="!submitBtn">
                            ...
                            <div class="right-content-next">
                                <div class="right-next-title"><span class="require">*</span>
                                    {{item.questionName}}
                                        【附件上传】</div>
                                <div class="right-next-remind">{{item.auxiliaryExplain}}</div>
                                <div class="search-next" v-if="submitBtn">
                                    <Upload class="uploadBtn" v-model="item.fileuploadanswer" :fileSize="20"  :limit="1" fileType="jpg,png" tip="支持上传jpg , png附件；单个附件大小不能超过20M ; 只允许上传一个文件;"></Upload>
                                </div>
                                <div v-if="!submitBtn">
                ...
                <div class="form-bottom-btns" v-if="resultData.questions&&resultData.questions.length>0" >
                    ...
                    <el-button type="primary" @click="handleSave('ruleForm',2)" style="width: 85px;height: 36px;padding: 0" v-if="submitBtn ">提交</el-button>
                </div>
            </el-form>
        </div>
      </div>
