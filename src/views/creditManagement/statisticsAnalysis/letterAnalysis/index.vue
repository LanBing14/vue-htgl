  ...
  <div>
    ...
    <div class="page-content">
      ...
      <div class="page-content-body">
        <TableWrapper
          ref="child"
          :fetchDataFn="Api_GetOccupancyPage"
          :order="order"
...
import {
  Api_GetOccupancyPage,
  Api_GetOccupancyStatistics,
...
export default {
  ...
  data() {
    ...
    return {
      ...
      order: "",
      statisticCol: [
        { name: "期初占用额度", key: "occupyBegin", isMoney: true },
        { name: "期末占用额度", key: "occupyEnd", isMoney: true },
        { name: "本月占用额度", key: "occupyTotal", isMoney: true },
        { name: "本月释放额度", key: "releaseTotal", isMoney: true },
      ],
    };
  },
  mounted() {
  ...
  methods: {
    ...
    handleReset(formName) {
      ...
      this.time = nowYear + "-" + lastMonth;
      this.$refs[formName].resetFields();
    },
    // 获取统计信息
    // getInfo() {
    //     Api_GetOccupancyStatistics(this.listQuery).then(res => {
    //         this.occupyBegin = res.occupyBegin;
    //         this.occupyEnd = res.occupyEnd;
    //         this.occupyTotal = res.occupyTotal;
    //         this.releaseTotal = res.releaseTotal;
    //     }).catch(res => {
