  ...
  <div>
    ...
    <div class="page-content">
      ...
      <StatisticsBlock
        :col="statisticCol"
        :query="listQuery"
        :fn="Api_WarningReportStatistics"
        ref="ref_StatisticsBlock"
      ></StatisticsBlock>
      <TableWrapper
        ref="child"
        :fetchDataFn="Api_WarningReportPage"
        :query="listQuery"
        :columns="tableCol"
        :order="order"
...
import {
  Api_WarningReportPage,
  Api_WarningReportStatistics,
} from "@/api/creditManagement/statisticsAnalysis/warningReport";
  ...
  data() {
    return {
      ...
      tableCol: [
        ...
        { label: "预警天数", props: { sortable: "custom" }, key: "day" },
        {
          label: "合同负责人",
          key: "dutyName",
          render: (h, data, row) => {
      ...
      statisticCol: [
        ...
        { name: "应收账款笔数", key: "count", isMoney: false },
      ],
    };
  },
  mounted() {
