        ...
        d.call(d3.behavior.drag()
            ...
            .on("drag", function (d, i) {
                ...
                d3.selectAll("." + dragit.mouse.scope).selectAll(".lineTrajectory").forEach(function (e, j) {
                    ...
                    var index_closest_time = closest_datapoints.indexOf(Math.min.apply(Math, closest_datapoints));// +
                    // dragit.time.min;
                    ...
                    // Store all the closest distances between the mouse and the current
                    // trajectory point
                    // Will be further used to find out the closest index (if scope is
                    // broader than 1 trajectory)
                ...
                // Find the index of the closest trajectory by looking at the shortest
                // distance
                ...
                // It can happens the trajectory is not fully displayed yet, then leave
                // because no closest one
                ...
                if (dragit.object.dragging == "relative") {
                    ...
                    // list_closest_trajectorypoint[index_closest_trajectorypoint][0])
